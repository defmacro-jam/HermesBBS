...
(define-pascal-record message-record
    ()
  (title (:pascal-string 80))
  (from-user-number :int16)
  (from-user-name (:pascal-string 40))
  (to-user-number :int16)
  (to-user-name (:pascal-string 40))
  (anonymous-from :boolean)
  ...
  (file-name (:pascal-string 31))
  (mac-file :boolean)
  (has-read :boolean)
  (reserved (:byte-array 21)))

(define-pascal-record email-record
    ()
  (title (:pascal-string 40))
  (from-user :int16)
  (to-user :int16)
  (anonymous-from :boolean)
  (anonymous-to :boolean)
